...
import xyz.gabriwar.warpedpixeldungeon.items.armor.Armor.Glyph;
...
public class Viscosity extends Glyph {
	...
	private static ItemSprite.Glowing PURPLE = new ItemSprite.Glowing( 0x99AA33 );
	...
	public int proc( Armor armor, Char attacker, Char defender, int damage ) {
		...
		tracker.level = armor.buffedLvl();
		tracker.glyphPower = power();
	...
	public static class ViscosityTracker extends Buff {
		...
		public int deferDamage(int dmg){
			...
			percent *= glyphPower; //scales with glyph level

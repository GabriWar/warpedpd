...
import xyz.gabriwar.warpedpixeldungeon.actors.buffs.GravityChaosTracker;
...
import xyz.gabriwar.warpedpixeldungeon.actors.buffs.SuperNovaTracker;
		...
		public boolean effect(Item origin, Char user, Ballistica bolt, boolean positiveOnly) {
			...
			try {
				...
				if(Messages.lang() != Languages.ENGLISH){
					...
					WarpedPixelDungeon.runOnRenderThread(
							new Callback() {
								@Override
								public void call() {
									GameScene.show(

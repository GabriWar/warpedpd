...
import xyz.gabriwar.warpedpixeldungeon.actors.buffs.EnhancedRings;
import xyz.gabriwar.warpedpixeldungeon.actors.buffs.MagicImmune;
import xyz.gabriwar.warpedpixeldungeon.actors.hero.Hero;
import xyz.gabriwar.warpedpixeldungeon.actors.hero.Talent;
import xyz.gabriwar.warpedpixeldungeon.actors.hero.spells.SpiritForm;
	...
	private static final LinkedHashMap<String, Integer> gems = new LinkedHashMap<String, Integer>() {
		{
			...
			put("adamant",ItemSpriteSheet.ADAMANT_RING);

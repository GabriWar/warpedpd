...
public class StewedMeat extends Food {
	...
	//monster meat stews just the same
	public static class oneMonsterMeat extends Recipe.SimpleRecipe{
		{
			inputs =  new Class[]{MonsterMeat.class};
			inQuantity = new int[]{1};
	...
	public static class twoMonsterMeat extends Recipe.SimpleRecipe{
		{
			inputs =  new Class[]{MonsterMeat.class};
			inQuantity = new int[]{2};
	...
	public static class threeMonsterMeat extends Recipe.SimpleRecipe{
		{
			inputs =  new Class[]{MonsterMeat.class};
			inQuantity = new int[]{3};

...
public class Bomb extends Item {
	...
	public void explode(int cell){
		...
		if (explodesDestructively()) {
			...
			//collect wall neighbors to destroy
			ArrayList<Integer> wallsToBreak = new ArrayList<>();
	...
	public static class DoubleBomb extends Bomb{
		...
		public boolean doPickUp(Hero hero, int pos) {
			...
			if (bomb.doPickUp(hero, pos)) {
				...
				if (WPDSettings.language() == Languages.ENGLISH)
	...
	public static class EnhanceBomb extends Recipe {
		...
		static {
			...
			validIngredients.put(PotionOfParalyticGas.class,    DizzyBomb.class);
			validIngredients.put(ScrollOfLullaby.class,         DumplingBomb.class);
			validIngredients.put(PotionOfLevitation.class,      ClusterBomb.class);
			validIngredients.put(ScrollOfMagicMapping.class,    SmartBomb.class);
		}
		...
		static {
			...
			bombCosts.put(DizzyBomb.class,      2);
			bombCosts.put(DumplingBomb.class,    3);
			bombCosts.put(ClusterBomb.class,     4);
			bombCosts.put(SmartBomb.class,       4);
		}

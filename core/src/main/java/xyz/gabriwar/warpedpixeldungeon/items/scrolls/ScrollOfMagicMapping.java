...
public class ScrollOfMagicMapping extends Scroll {
	...
	public void doRead() {
		...
		//the deepest floors ward off scrying, as they do for the Blueberry: past depth 50
		//only the Spectacles' MagicSight lets you read the layout. Bail before the scroll
		//is spent.
		if (Dungeon.depth > 50 && curUser.buff(Spectacles.MagicSight.class) == null) {

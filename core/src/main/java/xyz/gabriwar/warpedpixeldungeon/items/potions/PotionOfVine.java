...
public class PotionOfVine extends Potion {
    ...
    {
        icon = ItemSpriteSheet.Icons.POTION_VINE;
    }
    ...
    private void spawnAt(int cell) {
        VineLasher vine = new VineLasher();
        vine.pos = cell;
        GameScene.add(vine);
        Actor.addDelayed(new Pushing(vine, cell, cell), -1f);
        vine.sprite.alpha(0);
        vine.sprite.parent.add(new AlphaTweener(vine.sprite, 1, 0.15f));
    }

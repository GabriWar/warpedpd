...
import xyz.gabriwar.warpedpixeldungeon.actors.blobs.GrassSmokeGas;
import xyz.gabriwar.warpedpixeldungeon.actors.buffs.Buff;
import xyz.gabriwar.warpedpixeldungeon.actors.buffs.High;
...
public class PotionOfGrass extends Potion {
    ...
    {
        icon = ItemSpriteSheet.Icons.POTION_GRASS;
    }

    @Override
    public void apply(Hero hero) {
        identify();
        Buff.affect(hero, High.class).set(High.DURATION);
    }

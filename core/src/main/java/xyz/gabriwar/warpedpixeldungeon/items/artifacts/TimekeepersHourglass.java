...
public class TimekeepersHourglass extends Artifact {
	...
	/**
	 * Activates the timeFreeze effect with the given charge value.
	 * Used by PotionOfTime to trigger the freeze effect from outside the artifact.
	 */
	public void activateTimeFreeze(int chargeAmount) {
		charge = chargeAmount;
		GameScene.flash(0x80FFFFFF);
		Sample.INSTANCE.play(Assets.Sounds.TELEPORT);
		Invisibility.dispel(Dungeon.hero);
	...
	/**
	 * Activates the timeStasis effect with the given charge value.
	 * Used by plants (e.g. Clockcypress) to trigger the stasis effect from outside the artifact.
	 */
	public void activateTimeStasis(int chargeAmount) {
		charge = chargeAmount;
		GameScene.flash(0x80FFFFFF);
		Sample.INSTANCE.play(Assets.Sounds.TELEPORT);
		activeBuff = new timeStasis();

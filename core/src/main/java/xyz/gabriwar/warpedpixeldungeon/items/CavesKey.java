		...
		if (action.equals(AC_PORT)) {
			...
			if (Dungeon.depth < 25 && !Dungeon.bossLevel()) {
				...
				if (Statistics.albinoPiranhasKilled > 99) {
					Moonberry berry1 = new Moonberry();
					berry1.quantity = 10;
					berry1.doPickUp(Dungeon.hero, Dungeon.hero.pos);
					Cloudberry berry2 = new Cloudberry();
					berry2.quantity = 10;
					berry2.doPickUp(Dungeon.hero, Dungeon.hero.pos);
					Blueberry berry3 = new Blueberry();
					berry3.quantity = 10;
					berry3.doPickUp(Dungeon.hero, Dungeon.hero.pos);
					Blackberry berry4 = new Blackberry();
					berry4.quantity = 10;
					berry4.doPickUp(Dungeon.hero, Dungeon.hero.pos);
				}

...
public class Statistics {
	...
	public static boolean orbObtained;
	...
	private static final String ARCHERS_KILLED       = "archersKilled";
	private static final String SKELETONS_KILLED     = "skeletonsKilled";
	private static final String ALBINO_PIRANHAS_KILLED = "albinoPiranhasKilled";
	...
	public static void storeInBundle( Bundle bundle ) {
		...
		// Sprouted
		bundle.put( ARCHERS_KILLED, archersKilled );
		bundle.put( SKELETONS_KILLED, skeletonsKilled );
		bundle.put( ALBINO_PIRANHAS_KILLED, albinoPiranhasKilled );
	...
	public static void restoreFromBundle( Bundle bundle ) {
		...
		// Sprouted
		archersKilled       = bundle.getInt( ARCHERS_KILLED );
		skeletonsKilled     = bundle.getInt( SKELETONS_KILLED );
		albinoPiranhasKilled= bundle.getInt( ALBINO_PIRANHAS_KILLED );

...
public class KeyDisplay extends Visual {
	...
	static {
		...
		//sprouted keys share the vanilla sprites they already use, so they fold into
		//the same counter slots: the golden skeleton key reads as a golden key, the
		//skeleton key as an iron key
		keyMap.put(GoldenSkeletonKey.class, 3);
		keyMap.put(SkeletonKey.class, 4);
	}

...
import xyz.gabriwar.warpedpixeldungeon.sprites.DM100Sprite;
import xyz.gabriwar.warpedpixeldungeon.sprites.DM300Sprite;
...
import xyz.gabriwar.warpedpixeldungeon.sprites.KingSprite;
...
import xyz.gabriwar.warpedpixeldungeon.sprites.YogSprite;
	...
	public static void add_v0_8_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		if (DeviceCompat.isDesktop()) {
			...
			changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.SCROLL_TIWAZ, null), "Update Notification",
					...
					"The Google Play version of the game updates through Google Play itself and shows no prompt.\n\n" +

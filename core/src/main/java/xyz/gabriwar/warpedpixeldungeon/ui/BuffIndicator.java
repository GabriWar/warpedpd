...
import xyz.gabriwar.warpedpixeldungeon.windows.WndInfoBuff;
...
public class BuffIndicator extends Component {
	...
	// Weather-related buffs
	public static final int HYPOTHERMIA = 86;
	public static final int HEATSTROKE  = 87;
	public static final int DRENCHED    = 88;
	public static final int WINDSWEPT   = 89;
	public static final int MOONSTRUCK  = 90;
	public static final int MARK_OF_NUT = 91;
	public static final int DEWCHARGE   = 92;
	public static final int BUTTER      = 93;
	public static final int HALOMETHANEBURNING = 94;
	public static final int COUGHING    = 95;
	public static final int HEATAURA   = 96;
	public static final int SUGARRUSH  = 97;
	public static final int ROSEBARRIER= 98;
	public static final int DRUNK_ICON  = 99;

	// Ambient buffs
	public static final int AURORA_BLESS    = 100;
	public static final int FIREFLY_GLOW    = 101;
	public static final int SPRING_BLOOM    = 102;
	public static final int RAINBOW_BLESS   = 103;

	// Eclipse buffs
	public static final int SOLAR_ECLIPSE   = 104;
	public static final int BLOOD_MOON      = 105;

	// Crouch buff
	public static final int CROUCHING       = 106;

	// Sleepiness buff
	public static final int SLEEPINESS      = 107;
	public static final int EXHAUSTED       = 108;

	public static final int SOAKED_SHOES    = 109;

	//Re-ARranged PD ported icons
	public static final int DUEL_ANGEL      = 110;

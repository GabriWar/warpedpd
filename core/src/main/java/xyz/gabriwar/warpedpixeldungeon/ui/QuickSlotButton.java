...
public class QuickSlotButton extends Button {
	...
	public GameAction keyAction() {
		switch (slotNum){
			...
			case 1:
				return WPDAction.QUICKSLOT_2;
			case 2:
				return WPDAction.QUICKSLOT_3;
			case 3:
				return WPDAction.QUICKSLOT_4;
			case 4:
				return WPDAction.QUICKSLOT_5;
			case 5:
				return WPDAction.QUICKSLOT_6;
			default:
	...
	@Override
	public GameAction secondaryTooltipAction() {
		return WPDAction.QUICKSLOT_SELECTOR;
	}
	...
	public static void set(int slotNum, Item item){
		...
		if (Statistics.duration + Actor.now() <= 10){
			...
			if (containsWaterskin) WPDSettings.quickslotWaterskin(true);
		}
	}
	...
	public static void refresh() {
		...
		if (Statistics.duration + Actor.now() <= 10){
			...
			if (!containsWaterskin) WPDSettings.quickslotWaterskin(false);
		}
	}

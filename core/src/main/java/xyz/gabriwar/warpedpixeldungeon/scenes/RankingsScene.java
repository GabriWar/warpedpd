...
import xyz.gabriwar.warpedpixeldungeon.windows.WndDailies;
import xyz.gabriwar.warpedpixeldungeon.windows.WndRanking;
...
public class RankingsScene extends PixelScene {
	...
	public void create() {
		...
		if (Rankings.INSTANCE.latestDaily != null) {
			IconButton btnDailies = new IconButton(Icons.CALENDAR.get()) {
				...
				protected void onClick() {
					WarpedPixelDungeon.scene().addToFront(new WndDailies());
				}
		...
		} else if (Badges.isUnlocked(Badges.Badge.VICTORY) && !WPDSettings.victoryNagged()) {

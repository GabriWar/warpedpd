...
import xyz.gabriwar.warpedpixeldungeon.ui.RadialMenu;
						...
						if (Dungeon.hero != null) {
							...
							Game.scene().addToFront(new RadialMenu(Messages.get(Toolbar.class, "container_prompt"), info, names, images){
								...
								public void onSelect(int idx, boolean alt) {
									...
									if (items.size() == 0){
										WarpedPixelDungeon.scene().addToFront(new WndMessage(Messages.get(AlchemyScene.class, "no_items")));
										return;
									}

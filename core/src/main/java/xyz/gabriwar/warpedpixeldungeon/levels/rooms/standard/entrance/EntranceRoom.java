...
package xyz.gabriwar.warpedpixeldungeon.levels.rooms.standard.entrance;
...
import xyz.gabriwar.warpedpixeldungeon.levels.rooms.standard.exit.CircleWallEntranceRoom;
...
public class EntranceRoom extends StandardRoom {
	...
	public static void placeEarlyGuidePages(Level level, Room r){
		...
		if (Dungeon.depth == 1 &&
				(!Document.ADVENTURERS_GUIDE.isPageRead(Document.GUIDE_INTRO) || WPDSettings.intro() )){
			int pos;
			do {

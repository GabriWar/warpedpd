...
public class HeapGenTrap extends Trap {
	...
	// In Sprouted this was a static flag checked by external Sokoban systems.
	// We keep it as an instance field and persist it.
	public boolean heapGenerated = false;
	...
	private static final String HEAP_GENERATED = "heap_generated";

	@Override
	public void storeInBundle(Bundle bundle) {
		super.storeInBundle(bundle);
		bundle.put(HEAP_GENERATED, heapGenerated);
	}

	@Override
	public void restoreFromBundle(Bundle bundle) {
		super.restoreFromBundle(bundle);
		heapGenerated = bundle.getBoolean(HEAP_GENERATED);
	}
}

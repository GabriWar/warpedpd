...
public class TunnelRoom extends ConnectionRoom {
	...
	public void paint(Level level) {
		paint(this, level, level.tunnelTile());
	}

	//shared so other connection rooms can lay the same tunnel shape with a different
	//floor tile (pit/ember variants ported from cursed-pixel-dungeon)
	public static void paint(TunnelRoom room, Level level, int floor) {
		room.paintTunnel(level, floor);
	}

	protected void paintTunnel(Level level, int floor) {

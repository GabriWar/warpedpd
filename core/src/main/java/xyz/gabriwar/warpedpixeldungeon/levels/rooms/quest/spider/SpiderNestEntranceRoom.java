...
package xyz.gabriwar.warpedpixeldungeon.levels.rooms.quest.spider;
...
//Prison-side mouth of the spider nest: a web-choked hole in the floor
public class SpiderNestEntranceRoom extends StandardRoom {
	...
	public void paint(Level level) {
		...
		level.transitions.add(new LevelTransition(level,
				...
				SpiderNestLevel.FIRST_DEPTH,
				SpiderNestLevel.SPIDER_BRANCH,
				LevelTransition.Type.BRANCH_ENTRANCE));

		Painter.set( level, entrance, Terrain.EXIT );

		//webbing spreading out from the hole

...
public class WPDSettings extends GameSettings {
	...
	public static void fullscreen( boolean value ) {
		...
		WarpedPixelDungeon.updateSystemUI();
	}
	...
	public static void landscape( boolean value ){
		...
		((WarpedPixelDungeon)WarpedPixelDungeon.instance).updateDisplaySize();
	}
	...
	public static final String KEY_SUNDIAL      = "sundial";
	...
	public static void sundial( boolean value ){
		put( KEY_SUNDIAL, value );
	}

	public static boolean sundial(){
		return getBoolean( KEY_SUNDIAL, true );
	}
	...
	public static void inspector( boolean value ) {
		put( KEY_INSPECTOR, value );
	}

	public static boolean inspector() {
		return getBoolean( KEY_INSPECTOR, false );
	}

	//unlocked by holding the WPD avatar in the credits for 5s; reveals debug settings
	public static final String KEY_DEBUG_UNLOCKED = "debug_unlocked";

	public static void debugUnlocked( boolean value ) {
		put( KEY_DEBUG_UNLOCKED, value );
	}

	public static boolean debugUnlocked() {
		return getBoolean( KEY_DEBUG_UNLOCKED, false );
	}

	public static final String KEY_SUPPORTER = "supporter";

	//set on a verified store donation or restore; Ko-fi support can't be verified
	//in-game, so this only tracks store builds
	public static void supporter( boolean value ) {
		put( KEY_SUPPORTER, value );
	}
	...
	public static final String KEY_MP_NAME = "multiplayer_name";

	public static void multiplayerName( String value ){
	...
	public static final String KEY_MP_LAST_IP   = "mp_last_ip";
	public static final String KEY_MP_LAST_PORT = "mp_last_port";

	public static void lastMultiplayerIP(String value){
		put(KEY_MP_LAST_IP, value);
	}

	public static String lastMultiplayerIP(){
		return getString(KEY_MP_LAST_IP, "");
	}

	public static void lastMultiplayerPort(int value){
		put(KEY_MP_LAST_PORT, value);
	}

	public static int lastMultiplayerPort(){
		return getInt(KEY_MP_LAST_PORT, 5800);
	}
	...
	public static final String KEY_CLOCK_CYCLE = "clock_based_cycle";

	public static void clockBasedCycle( boolean value ) {
		put( KEY_CLOCK_CYCLE, value );
	}

	public static boolean clockBasedCycle() {
		return getBoolean( KEY_CLOCK_CYCLE, false );
	}

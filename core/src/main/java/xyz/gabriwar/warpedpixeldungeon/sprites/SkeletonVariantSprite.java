...
public class SkeletonVariantSprite extends SkeletonSprite {

	public SkeletonVariantSprite(){
		this( 0 );
	}

	public SkeletonVariantSprite( int color ){
		super();
		color = Math.floorMod( color, 6 );   //heals any bad tint from old saves
		texture( "sprites/skeleton_v" + color + ".png" );

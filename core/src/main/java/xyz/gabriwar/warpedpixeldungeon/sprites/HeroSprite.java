...
public class HeroSprite extends CharSprite {
	...
	/** Constructor for network player heroes (not Dungeon.hero) */
	public HeroSprite(xyz.gabriwar.warpedpixeldungeon.actors.hero.Hero hero) {
		super();
	...
	public void place( int p ) {
		super.place( p );
		// Only the local player's own hero drives the camera — otherwise a remote hero
		// walking would yank this client's view onto them.

...
public class DragonVariantSprite extends AdultDragonVioletSprite {

	public DragonVariantSprite(){
		this( 0 );
	}

	public DragonVariantSprite( int color ){
		super();
		color = Math.floorMod( color, 6 );   //heals any bad tint from old saves
		texture( "sprites/dragon_v" + color + ".png" );

...
public class Corruption extends AllyBuff {
	...
	//on the hero, corruption is endless but lifts the moment anything heals
	// them: if HP rose since the last tick, the buff is driven out
	...
	public boolean act() {
		if (target instanceof Hero){
			if (lastHP != -1 && target.HP > lastHP){
				GLog.p( Messages.get(this, "hero_cured") );
				detach();
				return true;
			}
		}

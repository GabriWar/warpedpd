...
import xyz.gabriwar.warpedpixeldungeon.sprites.MrDestructo2dot0Sprite;
...
public class MrDestructo2dot0 extends Mob {
	...
	@Override
	public int drRoll() {
		return super.drRoll() + Random.NormalIntRange(0, 35);
	}
	...
	protected void dropExtraLoot() {
		trackedDrop(new InactiveMrDestructo2(), 0);
	}

	public static MrDestructo2dot0 spawnAt( int pos ) {
		MrDestructo2dot0 m = new MrDestructo2dot0();
		m.pos = pos;
		m.state = m.HUNTING;

...
public class SubBranch extends BranchSkill {
	...
	protected int totalSpent(){
		return Dungeon.hero.heroSkills.totalSpent(CurrentSkills.BRANCHES.SUBCLASS);
	}

	@Override
	protected int nextUpgradeCost(){
		return Dungeon.hero.heroSkills.nextUpgradeCost(CurrentSkills.BRANCHES.SUBCLASS);
	}

	@Override
	protected boolean canUpgrade(){
		return Dungeon.hero.heroSkills.canUpgrade(CurrentSkills.BRANCHES.SUBCLASS);
	}
}

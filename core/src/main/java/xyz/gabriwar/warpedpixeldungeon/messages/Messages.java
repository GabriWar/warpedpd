...
public class Messages {
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("xyz.gabriwar.warpedpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
	...
	public static String format( String format, Object...args ) {
		try {
			...
			WarpedPixelDungeon.reportException( new Exception("formatting error for the string: " + format, e) );
			return format;
		}
	}

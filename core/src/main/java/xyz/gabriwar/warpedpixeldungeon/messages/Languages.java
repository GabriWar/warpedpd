...
package xyz.gabriwar.warpedpixeldungeon.messages;

import java.util.Locale;

//every translation below is inherited from Shattered PD: the Warped-specific text
//(items, actors, plants, guide) is English-only until translated, so nothing but
//English can honestly be marked complete

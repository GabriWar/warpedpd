...
import xyz.gabriwar.warpedpixeldungeon.actors.blobs.Firewind;
import xyz.gabriwar.warpedpixeldungeon.effects.particles.poisonparticles.CrimsoncrownPoisonParticle;
...
public class Crimsoncrown extends Plant {
	...
	@Override
	public float temperatureBonus() { return 35f; }
	...
	public void activate( Char ch ) {
		if (ch == null) {
			//OPD no-arg activate(): seed firewind at the plant's position
	...
	public void spiceEffect( Char ch ) {
		...
		GameScene.add(Blob.seed(newpos, 40, Firewind.class));
	}

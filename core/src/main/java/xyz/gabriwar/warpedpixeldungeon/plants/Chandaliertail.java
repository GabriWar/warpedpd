...
import xyz.gabriwar.warpedpixeldungeon.effects.particles.poisonparticles.ChandaliertailPoisonParticle;
...
public class Chandaliertail extends Plant {
	...
	public void activate( Char ch ) {
		if (ch == null) {
			//OPD no-arg activate(): seed a cloud of glowing gas
	...
	public void spiceEffect( Char ch ) {
		...
		Buff.prolong(ch, Glowing.class, 4f);
	}

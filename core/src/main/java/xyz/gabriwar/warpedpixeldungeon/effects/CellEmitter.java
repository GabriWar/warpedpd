...
public class CellEmitter {
	...
	public static Emitter bottom( int cell ) {
		...
		tagNet(emitter, cell, "bottom");

		return emitter;
	}

	private static void tagNet(Emitter emitter, int cell, String type) {
		if (Emitter.netListener != null) {
			emitter.netCell = cell;
			emitter.netEmType = type;
		}
	}
}

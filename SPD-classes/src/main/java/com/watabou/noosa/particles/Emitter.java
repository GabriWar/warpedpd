...
public class Emitter extends Group {
	...
	// Network sync metadata — set by CellEmitter when hosting
	public int netCell = -1;
	public String netEmType = null;

	// Static listener for network recording of particle effects
	public static NetEmitterListener netListener = null;

	public interface NetEmitterListener {
		void onBurst(int cell, String emType, Factory factory, int count);
		void onStart(int cell, String emType, Factory factory, float interval, int count);
	}
	...
	public void burst( Factory factory, int quantity ) {
		if (netCell >= 0 && netListener != null) {
			netListener.onBurst(netCell, netEmType, factory, quantity);
		}
	...
	public void start( Factory factory, float interval, int quantity ) {
		if (netCell >= 0 && quantity > 0 && netListener != null) {
			netListener.onStart(netCell, netEmType, factory, interval, quantity);
		}

...
public class IOSLauncher extends IOSApplication.Delegate {
	...
	protected IOSApplication createApplication() {
		...
		//StoreKit donations; leaves the supporter page store-backed (no Ko-fi) on iOS
		IOSPayments payments = new IOSPayments();
		...
		//this is mostly a copy-paste from IOSApplication.getPreferences
			...
			File finalPath = new File(libraryPath, WPDSettings.DEFAULT_PREFS_FILE + ".plist");
			...
			WPDSettings.set(new IOSPreferences(nsDictionary, finalPath.getAbsolutePath()));
		//end of prefs setup
		...
		config.overrideRingerSwitch = WPDSettings.ignoreSilentMode();
		...
		return new IOSApplication(new WarpedPixelDungeon(new IOSPlatformSupport()), config){
			@Override

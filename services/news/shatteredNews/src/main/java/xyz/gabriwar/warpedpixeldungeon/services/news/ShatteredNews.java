...
package xyz.gabriwar.warpedpixeldungeon.services.news;
...
public class ShatteredNews extends NewsService {
	...
	public void checkForArticles(boolean useMetered, boolean preferHTTPS, NewsResultCallback callback) {
		...
		if (preferHTTPS) {
			httpGet.setUrl("https://gabriwar.github.io/warped-pixel-dungeon/feed/wpd_ingame.xml");
		} else {
			httpGet.setUrl("http://gabriwar.github.io/warped-pixel-dungeon/feed/wpd_ingame.xml");
		}
